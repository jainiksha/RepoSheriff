...
- Return only valid JSON.
      ...
      // The API normally returns { reply: "..." }
      if (typeof data?.reply === "string") {
        ...
        try {
          ...
          // Sometimes there may be text before/after the JSON.
      ...
      // Also support an API that already returns structured JSON.
        ...
        <div className="overflow-hidden rounded-3xl border border-[#e9e2cf] bg-white shadow-lg">
          ...
          <div className="grid gap-6 p-6 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-[#e9e2cf] bg-[#fffdf5] p-6">
              ...
              {scanResult?.summary && (
                <p className="mt-4 text-sm leading-6 text-[#6b685f]">
                  {scanResult.summary}
                </p>
              )}
